...
export function tierColor(tier: string): string {
  if (tier.includes("6")) return "bg-amber-100 text-amber-700";
  if (tier.includes("5")) return "bg-teal-100 text-teal-700";
  if (tier.includes("4")) return "bg-blue-100 text-blue-700";
